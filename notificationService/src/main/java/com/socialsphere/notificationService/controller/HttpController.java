...
import com.socialsphere.notificationService.models.Message;
...
public class HttpController {
    ...
    public List<NotificationDto> getNotifications(){
        ...
        return notifications.stream()
                .map(notification -> new NotificationDto(notification.getUserId(), notification.getMessage() , notification.getType(),notification.getTimestamp()))
